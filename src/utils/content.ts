...
const en = {
    ...
    voteSteps: [
      {
        ...
        cta: 'Register today',
        href: 'https://www.markham.ca',
      },
      {
        title: 'Vote Oct 16–26',
  ...
  events: {
    badge: 'Events',
    title: 'Meet Yu in person',
    body: 'Through the campaign, Yu is showing up at community events across Ward 2: morning runs, meetups and street walks. Come join him.',
    subCalendar: 'Subscribe to calendar',
    tabEvents: 'Upcoming events',
    tabJourney: "Yu's journey",
    hostCard: 'Interested in hosting an event at your business?',
  ...
  involved: {
    ...
    partnerBody:
      'We are looking for businesses that want to build a healthy Markham together: sponsor a community run, host a meetup, or put a sign in your window.',
  ...
  donate: {
    ...
    rebateBody:
      'Markham residents who donate $50 or more to a council candidate may apply for a City rebate; conditions apply. Confirm details on markham.ca.',
...
const zhHK: typeof en = {
  ...
  events: {
    badge: '活動',
    title: '與余浩輝見面',
    body: '競選期間，余浩輝將現身第二選區的各個社區活動——晨跑、見面會、掃街。歡迎您的參與。',
    subCalendar: '訂閱活動日曆',
    tabEvents: '近期活動',
    tabJourney: '余浩輝的旅程',
  ...
  involved: {
    ...
    partnerTitle: '商業合作',
    partnerBody:
      '我們正尋找願意共建健康萬錦的商戶——贊助社區跑步、舉辦聚會，或在櫥窗擺放標語牌。',
    partnerCta: '聯絡競選團隊',
    volTitle: '義工',
  ...
  donate: {
    ...
    rebateTitle: '捐款回贈',
    rebateBody:
      '萬錦居民向市議員候選人捐款$50或以上，可向市政府申請回贈（受條件限制）。詳情請於 markham.ca 查閱。',
